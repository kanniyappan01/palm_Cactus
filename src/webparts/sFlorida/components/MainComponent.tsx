...
const MainComponent = (props) => {
  ...
  const handleSearch = (val) => {
   ...
   val.property !="" ? item.PropertyAddress.toLowerCase().includes(val.property.trim().toLowerCase()):item
    )
    filteredResults = filteredResults.filter((li)=> val.user.trim() !="" ?li.Name.toLowerCase().includes(val.user.trim().toLowerCase()) || li.PeopleEmail.toLowerCase().includes(val.user.trim().toLowerCase()):li );
